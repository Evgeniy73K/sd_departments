    ...
    {capture name="departments_table"}
        <div class="table-responsive-wrapper longtap-selection">
            ...
            >   {capture name="buttons"}
                {$allow_save=true}
                {include file="common/view_tools.tpl" url="departments.update?product_id="}
                {/capture}
                {if $allow_save}
                ...
                {/if}
                <td>
                <img srcset="{$department.main_pair.icon.image_path}" src="{$department.main_pair.icon.image_path}" width="50" height="66" alt="" class="products-list__image--img" title="">
                </td>
